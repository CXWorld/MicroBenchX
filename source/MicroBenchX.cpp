...
{
	double_t ipc = (double)instructions / ((double)clockSpeedMHz * 1E03 * time);
	printf("%-20s %-10.2f %-5.2f \n", testName.c_str(), 1E-03 * time, ipc);
}
...
int main()
{
	...
	ftime(&end);
	time_diff_ms = 1E03 * (end.time - start.time) + (end.millitm - start.millitm);
	...
	PrintIpcResults("Add AVX256 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Add AVX512 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Add AVX512 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Add Interger 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Add SSE128 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Add SSE128 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("And Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Div AVX256 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Div AVX512 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Div Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Div SSE128 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mix Integer Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Madd AVX256 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Madd SSE128 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Copy Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Copy Deep Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Copy Self Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul AVX256 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul AVX256 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul AVX512 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul AVX512 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul SSE128 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Mul SSE128 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Or Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub AVX256 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub AVX256 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub AVX512 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub AVX512 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub SSE128 Float", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Sub SSE128 Integer", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Xor Integer 64", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Zen FPU Mix 21", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
	...
	PrintIpcResults("Zen FPU Mix 22", add_avx256_float_Iterations, time_diff_ms, clockSpeed_MHz);
}
